...
namespace UpperComputer2
{
    class joystick
    {
        ...
        //{
        //    joystick.JOYINFOEX infoEx = new joystick.JOYINFOEX();
        //    infoEx.dwSize = Marshal.SizeOf(typeof(joystick.JOYINFOEX));
        //    infoEx.dwFlags = (int)JoystickAPI.JOY_RETURNBUTTONS;
        //    int result = joystick.joyGetPosEx(1, ref infoEx);
        //}
        //SharpDX.XInput.DeviceSubType
